<template>
  <f-collapse simple>
    <f-collapse-panel title="Pivot component" name="1">
      <f-table :columns="docCol1" :data="docData1" size="small" border></f-table>
    </f-collapse-panel>
    <f-collapse-panel title="fields element format" name="2">
      <f-tag type="primary" dark>Fields</f-tag>
      <f-table :columns="docCol2" :data="docData2" size="small" border></f-table>
      <f-divider></f-divider>
      <f-tag type="primary" dark>headers</f-tag>
      <f-table :columns="docCol2" :data="docData3" size="small" border></f-table>
    </f-collapse-panel>
    <f-collapse-panel title="Slots" name="3">
      <f-table :columns="docCol3" :data="docData4" size="small" border></f-table>
    </f-collapse-panel>
    <f-collapse-panel title="PivotTable component" name="4">
      <f-tag type="primary" dark>PivotTable</f-tag>
      <f-table :columns="docCol1" :data="docData5" size="small" border></f-table>
      <f-divider></f-divider>
      <f-tag type="primary" dark>row-fields/col-fields</f-tag>
      <f-table :columns="docCol2" :data="docData6" size="small" border></f-table>
    </f-collapse-panel>
  </f-collapse>
</template>
