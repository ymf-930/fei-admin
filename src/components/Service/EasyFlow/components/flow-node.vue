<template>
  ...
  >
    ...
    <div class="ef-node-right-ico" v-if="showState">
      <i class="f-iconfont f-icon-check-circle" v-show="node.state === 'success'"></i>
      <i class="f-iconfont f-icon-error" v-show="node.state === 'error'"></i>
      <i class="f-iconfont f-icon-warning-circle" v-show="node.state === 'warning'"></i>
      <i class="f-iconfont f-icon-loading" v-show="node.state === 'running'"></i>
    </div>
  </div>
</template>
...
const nodeIcoClass = computed(() => {
  const nodeIcon = {}
  nodeIcon[`f-iconfont f-icon-${props.node.ico}`] = true
