<template>
  <div class="easy-flow-container" :style="{ height }">
    <div class="ef-toolbar">
      <f-button type="text">{{ data.name }}</f-button>
      ...
      <div style="float: right; margin-right: 5px">
        <f-button size="small" type="info" plain icon="filedone" @click="infoVisible = true">
          流程信息
        </f-button>
        <f-dropdown trigger="click" style="margin: 0 10px" @command="dataReload">
          <f-button size="small" type="info" plain icon="database">数据源</f-button>
          <template #dropdown>
            <f-dropdown-menu>
              <f-dropdown-item name="dataA">dataA</f-dropdown-item>
              <f-dropdown-item name="dataB">dataB</f-dropdown-item>
              <f-dropdown-item name="dataC">dataC</f-dropdown-item>
              <f-dropdown-item name="dataD">dataD</f-dropdown-item>
            </f-dropdown-menu>
          </template>
        </f-dropdown>
        <f-button size="small" type="info" plain icon="book" @click="helpVisible = true">
          帮助
        </f-button>
      </div>
    </div>
...
import { Message, MessageBox } from 'f-ui-one'
import './index.styl'
