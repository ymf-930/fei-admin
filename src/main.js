...
import { registerUI } from '@/plugins/f-ui'
...
import 'f-ui-one/styles/normalize.css' // 初始化样式
import 'f-ui-one/styles/scrollbar.css' // 滚动条样式
import 'f-ui-one/styles/index.css' // 组件库样式
