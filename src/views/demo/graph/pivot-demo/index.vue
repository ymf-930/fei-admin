<template>
  <page-container title="Pivot Table" desc="交叉表，根据不同配置动态获取不同的表格显示。">
    ...
    <f-collapse-wrap title="PivotTable (standalone)" shadow="none" :model-value="false" collapse>
      <div class="p16">
        <pivot-table
          :data="asyncData"
    ...
    <f-collapse-wrap title="Pivot with advanced reducer" shadow="none" :model-value="false" collapse>
      <div class="p16">
        <pivot
    ...
    <f-collapse-wrap title="Pivot Doc" shadow="none" :model-value="false" collapse>
      <div class="p16">
        <pivot-doc></pivot-doc>
      </div>
    </f-collapse-wrap>
