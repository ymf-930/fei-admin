<template>
  <page-container title="基础颜色" desc="基础颜色，系统主题会默认注入不同的主色和颜色，这里可以动态设置颜色查看效果">
    <theme-color-panel />
    <f-collapse-wrap title="颜色设置" shadow="none">
      <div class="p10">
        <f-alert>
          颜色值根据主色变换而来，颜色转换借助
        ...
        <f-divider align="left">primary</f-divider>
        ...
        <f-divider align="left">primary-light</f-divider>
        ...
        <f-divider align="left">menu color</f-divider>
