<template>
  <div class="analysis-wrap">
    ...
    <div class="analysis-center">
      <f-card :bordered="false" shadow="never" :body-style="{ padding: '10px' }">
        <template #header>
        ...
        <f-skeleton :loading="loading" animation>
          <template #template>
            <f-skeleton style="margin-bottom: 16px" />
            <f-skeleton />
          </template>
          <template #default>
