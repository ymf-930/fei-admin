<template>
  <f-card :bordered="false" class="card-panel" shadow="never" :body-style="{ padding: '0' }">
    <template #header>
      <div flex="main:justify cross:center" style="font-weight: normal">
        ...
        <f-tooltip content="新增代办">
          <f-icon name="plus-circle" type="button" @click="handleAdd"></f-icon>
        </f-tooltip>
      </div>
    </template>
