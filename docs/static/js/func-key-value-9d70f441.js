import{a9 as m,k as _,j as g,D as n,a as v,w as o,o as x,c as e,d as h,q as I}from"./vendor-d80b6e14.js";import"./chunk-brace-bde7130a.js";const b=`import Sortable from 'sortablejs'
...
`,w={name:"FuncKeyValue",setup(){const a=_([{key:"1",value:"a"},{key:"2",value:"b"},{key:"3",value:"c"}]),t=g(()=>JSON.stringify(a.value,null,2));return{mapping:a,mappingJson:t,STR:b}}},k={class:"p16"};function y(a,t,S,l,V,B){const i=n("key-value-mapping"),c=n("f-divider"),s=n("b-ace-editor"),r=n("f-collapse-wrap"),d=n("f-col"),p=n("f-row"),u=n("page-container");return x(),v(u,{desc:"基础映射配置示例，可拖动排序，并封装了通用的hook钩子函数，可进行复用。"},{default:o(()=>[e(p,{gutter:16},{default:o(()=>[e(d,{span:"12"},{default:o(()=>[e(r,{title:"映射配置",shadow:"none"},{default:o(()=>[h("div",k,[e(i,{modelValue:l.mapping,"onUpdate:modelValue":t[0]||(t[0]=f=>l.mapping=f)},null,8,["modelValue"]),e(c,{align:"left"},{default:o(()=>[I("实际存储值")]),_:1}),e(s,{"model-value":l.mappingJson,readonly:""},null,8,["model-value"])])]),_:1})]),_:1}),e(d,{span:"12"},{default:o(()=>[e(r,{title:"useSortable",shadow:"none"},{default:o(()=>[e(s,{"model-value":l.STR,lang:"typescript",readonly:"",theme:"sqlserver",height:"850px",snippets:!1},null,8,["model-value"])]),_:1})]),_:1})]),_:1})]),_:1})}const F=m(w,[["render",y]]);export{F as default};
