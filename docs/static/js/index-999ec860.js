...
`,O={__name:"keyframe",setup(o){let i=[V("css_sprites.png")],c=["-10 -10","-430 -10","-10 -430","-430 -430","-850 -10","-850 -430","-10 -850","-430 -850","-850 -850","-1270 -10","-1270 -430","-1270 -850","-10 -1270","-430 -1270","-850 -1270","-1270 -1270"],l,s=!1;function p(){l&&(s?(s=!1,l.pause()):(s=!0,l.restart()))}return x(()=>{const r=document.getElementById("sprites");l=E().loadImage(i).changePosition(r,c,i[0]).repeatForever(),l.start(80),s=!0}),(r,_)=>{const f=a("f-divider"),u=a("f-alert"),g=a("f-col"),h=a("f-ace-editor"),$=a("f-collapse-wrap"),j=a("f-row");return d(),k("div",null,[t(u,{"show-icon":""},{desc:n(()=>[J,L,e("p",null,[m(" 2、 "),q,t(f,{type:"vertical"}),D])]),default:n(()=>[m(" 说明 ")]),_:1}),t(j,{gutter:16},{default:n(()=>[t(g,{span:"12"},{default:n(()=>[e("div",{id:"sprites",class:"rabbit",onClick:p})]),_:1}),t(g,{span:"12"},{default:n(()=>[t($,{title:"代码示例"},{default:n(()=>[t(h,{"model-value":K,lang:"typescript",readonly:"",theme:"sqlserver",height:"400px",snippets:!1})]),_:1})]),_:1})]),_:1})])}}},z=P(O,[["__scopeId","data-v-3b2af06f"]]),Q="/fei-admin/static/png/apng_test-b9078a02.png";const W={},w=o=>(G("data-v-19b05914"),o=o(),R(),o),X=w(()=>e("p",null," 1、关键帧导出后，可以制作apng用来直接显示动画，但这种方式不受代码控制，动画速率等只能在AE中进行调整后，导出序列帧再用转换工具进行转换 ",-1)),Y=w(()=>e("p",null," 2、好处就是使用十分方便，无需编码直接当成普通图片进行引用即可，比较推荐用于背景或者icon动效这种可以不受控制的内容 ",-1)),Z=w(()=>e("a",{href:"https://www.zhangxinxu.com/sp/apng/",target:"_blank"},"APNG合成工具",-1)),ee=w(()=>e("a",{href:"https://tinypng.com/",target:"_blank"},"png压缩工具",-1)),te=w(()=>e("div",{class:"rabbit"},[e("img",{src:Q})],-1));function ae(o,i){const c=a("f-divider"),l=a("f-alert"),s=a("f-col"),p=a("f-row");return d(),k("div",null,[t(l,{"show-icon":""},{desc:n(()=>[X,Y,e("p",null,[m(" 2、 "),Z,t(c,{type:"vertical"}),ee])]),default:n(()=>[m(" 说明 ")]),_:1}),t(p,{gutter:16},{default:n(()=>[t(s,{span:"24"},{default:n(()=>[te]),_:1}),t(s,{span:"12"})]),_:1})])}const ne=P(W,[["render",ae],["__scopeId","data-v-19b05914"]]);const y=o=>(G("data-v-f1665de6"),o=o(),R(),o),oe=y(()=>e("p",null," 1、Lottie 是 Airbnb 开源的一套跨平台的完整的动画效果解决方案,设计师可以使用 AE 设计动画之后,使用 Lottic 提供的 Bodymovin 插件将设计好的动画导出成 JSON 格式 ",-1)),se=y(()=>e("p",null,"2、好处就是大小很小，且可以自由进行控制和使用，矢量",-1)),ie=y(()=>e("a",{href:"http://airbnb.io/lottie/#/web",target:"_blank"},"lottie docs",-1)),le=y(()=>e("a",{href:"https://github.com/airbnb/lottie-web",target:"_blank"},"lottie-web",-1)),ce=y(()=>e("a",{href:"https://lottiefiles.com/",target:"_blank"},"lottiefiles",-1)),re={flex:""},_e="https://lottie.host/25a9ea9f-2a78-446c-a9e0-9b11dcb20aee/mdJJIHHT6p.json",pe=`
...
`,ve={__name:"pag",props:{url:{type:String,default:""}},setup(o){const i=o,c=v(null);async function l(){const s=await F(),p=await fetch(i.url).then(u=>u.arrayBuffer()),r=await s.PAGFile.load(p),_=c.value;_.width=r.width(),_.height=r.height();const f=await s.PAGView.init(r,_,{useScale:!1});f.setRepeatCount(0),await f.play()}return x(()=>{l()}),(s,p)=>{const r=a("f-divider"),_=a("f-alert"),f=a("f-col"),u=a("f-ace-editor"),g=a("f-collapse-wrap"),h=a("f-row");return d(),k("div",null,[t(_,{"show-icon":""},{desc:n(()=>[ue,me,e("p",null,[m(" 2、 "),ge,t(r,{type:"vertical"}),he])]),default:n(()=>[m(" 说明 ")]),_:1}),t(h,{gutter:16},{default:n(()=>[t(f,{span:"12"},{default:n(()=>[e("canvas",{class:"rabbit",ref_key:"imgRef",ref:c},null,512)]),_:1}),t(f,{span:"12"},{default:n(()=>[t(g,{title:"代码示例"},{default:n(()=>[t(u,{"model-value":be,lang:"typescript",readonly:"",theme:"sqlserver",height:"400px",snippets:!1})]),_:1})]),_:1})]),_:1})])}}};const we={class:"panel"},ye={class:"content-box"},Ae={__name:"index",setup(o){const i=v("tab1"),c=v([{key:"tab1",title:"关键帧"},{key:"tab2",title:"APNG"},{key:"tab3",title:"Lottie"},{key:"tab4",title:"Pag"}]);return(l,s)=>{const p=a("f-tabs"),r=a("page-wrapper");return d(),b(r,{desc:"多种动效使用方案，实际使用的时候根据实际需求进行不同方案的选择。以达到最好的动效方案。"},{default:n(()=>[e("div",we,[t(p,{modelValue:i.value,"onUpdate:modelValue":s[0]||(s[0]=_=>i.value=_),data:c.value,type:"card"},null,8,["modelValue","data"]),e("div",ye,[i.value==="tab1"?(d(),b(z,{key:0})):A("",!0),i.value==="tab2"?(d(),b(ne,{key:1})):A("",!0),i.value==="tab3"?(d(),b(de,{key:2})):A("",!0),i.value==="tab4"?(d(),b(ve,{key:3,url:B(V)("pag_test.pag")},null,8,["url"])):A("",!0)])])]),_:1})}}},Ie=P(Ae,[["__scopeId","data-v-3cdff6c2"]]);export{Ie as default};
